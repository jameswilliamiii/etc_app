class ApplicationController < ActionController::Base
  ...
  unless Rails.application.config.consider_all_requests_local
    ...
    rescue_from ActionController::UnknownFormat, ActionController::RoutingError, ActionController::UnknownController, ::AbstractController::ActionNotFound, ActiveRecord::RecordNotFound, ActionView::MissingTemplate, with: lambda { |exception| render_error 404, exception }
  end
